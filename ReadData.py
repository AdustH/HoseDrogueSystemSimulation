...
dataset = pyvista.read("../data/KC17.cas")
...
def get_velocity(x, y, z):
        poly_data = pyvista.PolyData(numpy.array([[x, y, z]]));
        velocity = [poly_data.sample(dataset)["X_VELOCITY"][0], poly_data.sample(dataset)["Y_VELOCITY"][0], poly_data.sample(dataset)["Z_VELOCITY"][0]];
        return velocity